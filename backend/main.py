...
# On Vercel, the structure might be flattened or different; search for frontend folder
FRONTEND_DIR = BACKEND_DIR.parent / "frontend"

if not FRONTEND_DIR.is_dir():
    # Fallback for some serverless environments
    FRONTEND_DIR = pathlib.Path.cwd() / "frontend"
...
if not FRONTEND_DIR.is_dir():
    ...
    print("  mood-productivity-app/")
    print("    backend/   <-- run uvicorn from here")
    print("    frontend/")
    sys.exit(1)
